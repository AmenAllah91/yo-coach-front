...
exercises: day.exercises.map((exercise: any) => ({
  ...
  addSet(exerciseIndex: number) {
    const nextSetNumber = this.trainingDays[this.selectedDayIndex].exercises[exerciseIndex].sets.length + 1;
    this.trainingDays[this.selectedDayIndex].exercises[exerciseIndex].sets.push({ setNumber: nextSetNumber, reps: 8, weight: 0, restMin: 1, restSec: 0, type: 'REGULAR' });
  }
